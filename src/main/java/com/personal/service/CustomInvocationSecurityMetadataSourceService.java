...
import com.personal.dao.PermissionRepository;
import com.personal.dao.RoleRepository;
    ...
    private void loadResourceDefine() {
       ...
       /*
        ...
        for (String roleName : roleNameList) {
            ...
            List<Permission>  permissionList = permissionRepository.findByRoleName(roleName);
            if(permissionList!=null && permissionList.size()>0) {//如果不加判断，这里如果 resourceRepository.findByRoleName(roleName);为null.则会报错
                for(Permission permission :permissionList){
                    urlList.add(permission.getPermissionName());
                }
            }
